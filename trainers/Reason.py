...
from networks.rp_model import make_r_model
from trainers.run_epoch import r_run_epoch
...
def r_train(args):
    ...
    model = make_r_model(args.mid, src_vocab, tgt_vocab, mid_vocabs, device,
    ...
    for epoch in range(args.num_epoch):
        ...
        model.train()
        train_state, average_loss, qsvo_acc, obj_acc, obj_type_acc = r_run_epoch(
            args.mid,
        ...
        print(
            ...
            "QSVO accuracy: %.4f | Object Accuracy: %.4f | Object Type Accuracy: %.4f"
            % (epoch, average_loss, qsvo_acc, obj_acc, obj_type_acc))
        ...
        with torch.no_grad():
            ...
            valid_state, average_loss, qsvo_acc, obj_acc, obj_type_acc = r_run_epoch(
                args.mid,
