...
from networks.e2e_model import make_e2e_model
from trainers.run_epoch import e2e_run_epoch
...
def e2e_train(args):
    ...
    model = make_e2e_model(args.mid, src_vocab, tgt_vocab, mid_vocabs, device,
    ...
    for epoch in range(args.num_epoch):
        ...
        model.train()
        train_state, average_loss, action_acc, qsvo_acc, obj_acc, obj_type_acc = e2e_run_epoch(
            args.mid,
        ...
        print(
            "Finish Training Epoch %d | Total loss: %6.2f | "
            "Accuracy: %.4f | QSVO accuracy: %.4f | Object Accuracy: %.4f | Object Type Accuracy: %.4f"
            % (epoch, average_loss, action_acc, qsvo_acc, obj_acc, obj_type_acc))
        ...
        with torch.no_grad():
            ...
            valid_state, average_loss, action_acc, qsvo_acc, obj_acc, obj_type_acc = e2e_run_epoch(
                args.mid,
            ...
            print(
                "Finish Evaluating Epoch %d | Valid Loss: %6.2f | "
                "Accuracy: %.4f | QSVO accuracy: %.4f | Object Accuracy: %.4f | Object Type Accuracy: %.4f"
                % (epoch, average_loss, action_acc, qsvo_acc, obj_acc, obj_type_acc))
